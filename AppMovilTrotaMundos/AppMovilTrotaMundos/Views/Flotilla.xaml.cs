...
namespace AppMovilTrotaMundos.Views
{
	public partial class Flotilla : ContentPage
	{
		public Flotilla()
		{
			InitializeComponent();
			BindingContext = new FlotillasViewModel();
			
		}
		protected override async void OnAppearing()
		{
			base.OnAppearing();
			var viewModel = BindingContext as FlotillasViewModel;
			await viewModel?.LoadFlotillasAsync(); // Llama a LoadClientesAsync si es necesario
		}
